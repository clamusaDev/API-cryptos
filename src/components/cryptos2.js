...
export const Cryptos2 = () => {
  ...
  return (
    <>
    <input value={search} onChange={searcher} type='text' placeholder='Search...' className='text-lg text-cyan-600' />
        ...
        <tbody>
            { results.map( (result)=> (
                <tr key={result.id}>
                    ...
                    <td><small><img src={result.image.small} alt='icons cryptos' /> {result.name} </small></td>
